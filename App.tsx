            ...
            >
              <div className="flex-1 flex flex-col items-center justify-center w-full">
                <div className="text-center mb-6 sm:mb-8">
                  <h2 className="text-2xl sm:text-3xl font-bold mb-2">Card Options</h2>
                  <p className="opacity-60 text-sm sm:text-base">Choose which card sets to include in the game.</p>
                </div>
                  ...
                  {cardSets.map((cardSet) => (
                    ...
                    >
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div>
                          <span className="font-medium block text-sm sm:text-base">{cardSet.name}</span>
                          <span className="text-xs opacity-60 hidden sm:block">{cardSet.description}</span>
                        </div>
                      </div>
