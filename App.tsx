...
const App: React.FC = () => {
  ...
  const currentPlayerName =
    players.length > 0 ? players[activePlayerIndex] : "Player";
            ...
            >
              ...
              <div className="shrink-0 w-full md:h-full flex flex-col justify-end md:justify-center md:items-center z-10 pb-safe">
                ...
                <div className="w-full md:max-w-sm flex flex-col gap-4 md:gap-8">
                  ...
                  {/* Turn Indicator */}
                  <div
                    className={`order-2 flex flex-row md:flex-col justify-between md:justify-center items-center gap-2 md:gap-4 p-4 rounded-xl backdrop-blur-sm transition-colors
                     ${theme === "classic" ? "bg-white/50 md:bg-gray-50" : "bg-white/5 md:bg-white/5"}`}
                  >
                    <div className="flex flex-col md:text-center">
                      <span className="text-[10px] md:text-xs font-bold tracking-widest uppercase opacity-50 mb-1">
                        Current Turn
                      </span>
                      <span className="text-xl md:text-3xl font-bold truncate max-w-[150px] md:max-w-full">
                        {currentPlayerName}
                      </span>
                    </div>
                    <Button
                  ...
                  {/* Deck Options Toggle */}
                  <div
                    className={`order-3 p-3 md:p-4 rounded-xl flex items-center justify-between transition-colors
                    ${theme === "classic" ? "bg-gray-100" : "bg-wnrs-darkgrey"}`}
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`p-2 rounded-full ${wildcardsEnabled ? "bg-wnrs-red text-white" : "bg-gray-400 text-white"}`}
                      >
                        <Sparkles size={16} />
                      </div>
                    ...
                    >
                      <motion.div
                        ...
                        style={{
                          backgroundColor:
                            wildcardsEnabled && theme === "midnight"
                              ? "black"
                              : "white",
                        }}
                      />
